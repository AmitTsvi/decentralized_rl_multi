...
#ifndef OPEN_SPIEL_GAMES_COOP_BOX_PUSHING_SERIAL_SOCCER_H_
#define OPEN_SPIEL_GAMES_COOP_BOX_PUSHING_SERIAL_SOCCER_H_
...
class CoopBoxPushingSerialState : public SimMoveState {
 public:
  CoopBoxPushingSerialState(std::shared_ptr<const Game> game, int horizon,
...
class CoopBoxPushingSerialGame : public SimMoveGame {
 public:
  explicit CoopBoxPushingSerialGame(const GameParameters& params);
...
#endif  // OPEN_SPIEL_GAMES_COOP_BOX_PUSHING_SERIAL
