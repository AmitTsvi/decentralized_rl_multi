...
def build_parser(auction=False, transformation='literal', pretrain_primitives=False, transfer=False):
    ...
    parser.add_argument('--players', type=int, default=1, help='specify number of players')
    ...
    if transformation == 'subpolicy':
        ...
        parser.add_argument('--num_primitives', type=int, default=1, help='number of functions to initialize for each player')
    return parser